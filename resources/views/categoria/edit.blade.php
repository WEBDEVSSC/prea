...
@section('content_header')
    <h1><strong>Categorias</strong> <small>Editar registro</small></h1>
@stop
            ...
            <div class="row">
                ...
                <form action="{{ route('categoriaUpdate', $categoria->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <p>Nombre</p>
                            <input type="text" name="nombre" id="nombre" class="form-control" value="{{ old('nombre',$categoria->categoria) }}">
                            @error('nombre')
