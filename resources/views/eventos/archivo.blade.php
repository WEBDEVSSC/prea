        ...
        <div class="card-body p-4">
            @if($eventos->isEmpty())
                <div class="text-center py-5">
                    ...
                    <h5 class="text-muted font-weight-normal">No hay eventos disponibles.</h5>
                </div>
            @else
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0 custom-material-table" id="table-eventos">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach($eventos as $evento)
                                <tr>
                                    ...
                                    <td>
                                        <span class="font-weight-bold text-dark">{{ $evento->incidente_categoria_label }}</span>
                                    </td>
                                    <td>
...
@section('css')
    ...
    <style>
        ...
        /* Ajustes visuales para controles de DataTables */
