...
@section('title', 'Eventos - Centinela')
    ...
    <div class="d-flex align-items-center justify-content-between my-2">
        <div>
            ...
            <p class="text-muted mb-0" style="font-size: 0.9rem;">
                Listado y Gestión de Eventos <span class="badge bg-danger-light text-danger font-weight-bold">Centinela</span>
            </p>
        </div>
    </div>
@stop
        ...
        <div class="card-body p-0">
            @if($eventos->isEmpty())
                <div class="text-center py-5">
                    ...
                    <h5 class="text-muted font-weight-normal">No hay eventos centinela registrados.</h5>
                </div>
            @else
