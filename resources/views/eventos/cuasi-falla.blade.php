...
@section('title', 'Eventos - Cuasi-Falla')
    ...
    <div class="d-flex align-items-center justify-content-between my-2">
        <div>
            ...
            <p class="text-muted mb-0" style="font-size: 0.9rem;">
                Listado y Gestión de <span class="badge bg-success-light text-success font-weight-bold">Cuasi - Falla</span>
            </p>
        </div>
    </div>
@stop
        ...
        <div class="card-body p-0">
            @if($eventos->isEmpty())
                <div class="text-center py-5">
                    ...
                    <h5 class="text-muted font-weight-normal">No hay eventos de Cuasi-Falla registrados.</h5>
                </div>
            @else
