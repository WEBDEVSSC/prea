...
<body>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 10pt;">
        ...
        <tbody>
            ...
            <tr>
                <td style="border: 1px solid #ccc; padding: 5px; font-weight: bold;">Total</td>
                <td style="border: 1px solid #ccc; text-align:center; font-weight: bold;">{{ $contadorEventos }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 10pt;">
        ...
        <tbody>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">J1 - Piedras Negras</td><td style="border: 1px solid #ccc; text-align:center;">{{ $totalJ1 }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">J2 - Acuña</td><td style="border: 1px solid #ccc; text-align:center;">{{ $totalJ2 }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">J3 - Sabinas</td><td style="border: 1px solid #ccc; text-align:center;">{{ $totalJ3 }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">J4 - Monclova</td><td style="border: 1px solid #ccc; text-align:center;">{{ $totalJ4 }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">J5 - Cuatro Ciénegas</td><td style="border: 1px solid #ccc; text-align:center;">{{ $totalJ5 }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">J6 - Torreón</td><td style="border: 1px solid #ccc; text-align:center;">{{ $totalJ6 }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">J7 - Fco. I. Madero</td><td style="border: 1px solid #ccc; text-align:center;">{{ $totalJ7 }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">J8 - Saltillo</td><td style="border: 1px solid #ccc; text-align:center;">{{ $totalJ8 }}</td></tr>
        </tbody>
    </table>
...
<div style="text-align:center; margin-top:20px;">
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 10pt;">
        ...
        <tbody>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Acciones Esenciales para la Seguridad del Paciente</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoAESP }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Medicación</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoMMU }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Prevención y Control de Infecciones</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoPCI }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Dispositivos y Equipos Biomédicos</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoDEB }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Acceso y Continuidad de la Atención</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoACC }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Derechos del Paciente</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoPFR }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Servicios Auxiliares de Diagnóstico</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoSAP }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Nutrición</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoNUT }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Anestesia y Atención Quirúrgica</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoASC }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Gestión de la Comunicación y la Información</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoMCI }}</td></tr>
            <tr><td style="border: 1px solid #ccc; padding: 5px;">Otro Incidente</td><td style="border: 1px solid #ccc; text-align:center;">{{ $tipoOTRO }}</td></tr>
        </tbody>
    </table>
